...
_GLOBALCONFIG = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='provisionPrometheusCert', full_name='v1alpha1.GlobalConfig.provisionPrometheusCert', index=56,
...
_GLOBALCONFIG.fields_by_name['provisionPrometheusCert'].message_type = github_dot_com_dot_gogo_dot_protobuf_dot_protobuf_dot_google_dot_protobuf_dot_wrappers__pb2._BOOLVALUE
