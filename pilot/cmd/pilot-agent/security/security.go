...
func SetupSecurityOptions(proxyConfig meshconfig.ProxyConfig, jwtPolicy, clusterIDVar, podNamespaceVar,
	...
	eccSigAlgEnv, credFetcherTypeEnv, credIdentityProvider string, xdsEnableTokenFetchExchange, fileMountedCertsEnv, pkcs8KeysEnv bool,
	...
	o := security.Options{
		...
		XdsEnableTokenFetchExchange:    xdsEnableTokenFetchExchange,
