...
var knownTypes = map[string]schemaType{
	...
	model.ClusterAuthenticationConfig.Type: {
		schema: model.ClusterAuthenticationConfig,
		object: &ClusterAuthenticationConfig{
			TypeMeta: meta_v1.TypeMeta{
				Kind:       "ClusterAuthenticationConfig",
				APIVersion: apiVersion(&model.ClusterAuthenticationConfig),
			},
		},
		collection: &ClusterAuthenticationConfigList{},
	},
...
// ClusterAuthenticationConfig is the generic Kubernetes API object wrapper
type ClusterAuthenticationConfig struct {
	meta_v1.TypeMeta   `json:",inline"`
	meta_v1.ObjectMeta `json:"metadata"`
	Spec               map[string]interface{} `json:"spec"`
}
...
// GetSpec from a wrapper
func (in *ClusterAuthenticationConfig) GetSpec() map[string]interface{} {
	return in.Spec
}

// SetSpec for a wrapper
func (in *ClusterAuthenticationConfig) SetSpec(spec map[string]interface{}) {
	in.Spec = spec
}

// GetObjectMeta from a wrapper
func (in *ClusterAuthenticationConfig) GetObjectMeta() meta_v1.ObjectMeta {
	return in.ObjectMeta
}

// SetObjectMeta for a wrapper
func (in *ClusterAuthenticationConfig) SetObjectMeta(metadata meta_v1.ObjectMeta) {
	in.ObjectMeta = metadata
}

// ClusterAuthenticationConfigList is the generic Kubernetes API list wrapper
type ClusterAuthenticationConfigList struct {
	meta_v1.TypeMeta `json:",inline"`
	meta_v1.ListMeta `json:"metadata"`
	Items            []ClusterAuthenticationConfig `json:"items"`
}

// GetItems from a wrapper
func (in *ClusterAuthenticationConfigList) GetItems() []IstioObject {
	out := make([]IstioObject, len(in.Items))
	for i := range in.Items {
		out[i] = &in.Items[i]
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ClusterAuthenticationConfig) DeepCopyInto(out *ClusterAuthenticationConfig) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ObjectMeta.DeepCopyInto(&out.ObjectMeta)
	out.Spec = in.Spec
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ClusterAuthenticationConfig.
func (in *ClusterAuthenticationConfig) DeepCopy() *ClusterAuthenticationConfig {
	if in == nil {
		return nil
	}
	out := new(ClusterAuthenticationConfig)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *ClusterAuthenticationConfig) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ClusterAuthenticationConfigList) DeepCopyInto(out *ClusterAuthenticationConfigList) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	out.ListMeta = in.ListMeta
	if in.Items != nil {
		in, out := &in.Items, &out.Items
		*out = make([]ClusterAuthenticationConfig, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ClusterAuthenticationConfigList.
func (in *ClusterAuthenticationConfigList) DeepCopy() *ClusterAuthenticationConfigList {
	if in == nil {
		return nil
	}
	out := new(ClusterAuthenticationConfigList)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *ClusterAuthenticationConfigList) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
