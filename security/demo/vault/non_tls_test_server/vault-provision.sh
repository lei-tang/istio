...
# gcloud container clusters get-credentials vault-server-non-tls-istio-ci-cd --zone us-west1-b --project endpoints-authz-test1
...
export VAULT_ADDR="http://35.233.183.49:8200"
