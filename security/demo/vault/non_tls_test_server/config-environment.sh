...
export CLUSTER=vault-server-non-tls-istio-ci-cd

# ISTIO_DIR points to your cloned istio directory
export ISTIO_DIR=~/go/src/istio.io/istio
# DIR points to your directory containing the non_tls_test_server
export DIR=${ISTIO_DIR}/security/demo/vault/non_tls_test_server
...
# such as $USER.
export TAG=vault-server-non-tls-istio-ci-cd-4-26-2019
